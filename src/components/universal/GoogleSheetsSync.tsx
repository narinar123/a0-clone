...
export default function GoogleSheetsSync({ sheetTitle, getData }: GoogleSheetsSyncProps) {
  ...
  return (
    <div className="flex flex-col gap-2">
      <button
        onClick={handleSync}
        disabled={isSyncing}
        className="flex items-center gap-2 px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 disabled:bg-emerald-800 text-white rounded-xl text-xs font-semibold transition-all shadow-md select-none"
      >
        {isSyncing ? (
          <>
