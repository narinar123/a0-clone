...
export default function AIChatbot({ projectName, contextPrompt }: AIChatbotProps) {
  ...
  const handleSend = (e: React.FormEvent) => {
    ...
    // AI Mock Response Logic based on context prompt
    setTimeout(() => {
      let botResponse = "";
          ...
          <div className="bg-[#111115] border-b border-[#232329] px-4 py-3 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[10px] text-gray-500">Trained on {projectName}</p>
              </div>
            </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            ...
            {isTyping && (
              <div className="flex justify-start">
                <div className="bg-[#18181b] text-gray-400 border border-[#232329] rounded-2xl rounded-bl-none px-4 py-2 text-sm flex items-center gap-1.5">
